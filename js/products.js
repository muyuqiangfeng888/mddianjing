...
const PRODUCTS = [
  ...
  },
  {
    ...
    notice: 'MF电竞点单须知<br>1.未成年人禁止下单，如有需要请在监护人陪同下进行；隐瞒年龄、执意购买者自行承担后果，与本店无关<br>2.对局内出现各种问题，如陪玩态度恶劣或恶意卡保底行为等请保存录屏及时联系客服处理<br>3.绝密单强制陪玩最低4听5甲，老板没带大红包的情况下陪玩必须给老板带<br>4.单价200r以下最低开一张房卡，单价200r-400r最低开三张房卡，单价400r以上包全卡，少开一张房卡保底+100w，通道卡陪玩必须全包<br>5.陪玩双倒的情况下老板兜底杀一个算炸一半，杀两个算炸单不计入保底，撤离失败保险物资价值不计入保底<br>6.机密炸单+30w保底，绝密炸单+该图战备同数（巴克什战备55w，航天战备60w，监狱战备78w）保底<br>7.单局带出不足100w不计入保底，老板不可故意丢弃或藏匿物资，一旦发现老板故意丢弃物资则直接结单，概不退款<br>8.对局中六套（6头耐久≥35，6甲耐久≥100）老板可选择性穿戴，计入保底总价值<br>9.陪玩局内出非洲之心以及海洋之泪必须免费给老板，老板自愿加鸡腿，心和泪计入保底<br>10.出现卡保底行为（结单时总带出价值≤保底＋炸单总价值+50w，赌约单除外），老板及时保存录屏联系客服处理<br>11.对局中请老板听从陪玩指挥，若老板因自身原因导致撤离失败则没有售后<br>12.老板可以提出合理要求，包括：想去哪里、想采用什么路线等，合理范围内的要求陪玩会尽量满足，没有提前说的要求不接受事后争议<br>13.禁止陪玩私加老板联系方式，老板无论以任何形式添加到陪玩联系方式，联系客服奖励200r<br>14.若因三角洲机制原因导致老板账号被追缴或封禁，该问题补偿方案如下:<br>（1）若确定是陪玩开挂则扣除打手押金并补偿给老板，该单全额退回并在封号期间按30/天补偿给老板，被追缴部分按60/ kw补偿给老板或者老板可选择联系客服安排其他陪玩车队打够追缴金额<br>（2）若是因为三角洲机制问题（如数据异常、打手绿玩但被举报次数过多、陪玩实力太强以及被官方判定为护航等）则正常结算订单以及以60/kw正常赔付追缴部分',
    platforms: [
  { key: 'mobile', label: '手游', price: 99, unit: '单', desc: '99r保底1288w', formUrl: 'https://doc.weixin.qq.com/forms/AH0AxweMAF8Ab4AWwaDAHkCNDse3Xidhf' },
  { key: 'pc',     label: '端游', price: 158, unit: '单', desc: '99r保底1288w', formUrl: 'https://doc.weixin.qq.com/forms/AH0AxweMAF8Ab4AWwaDAHkCN6rTC1wdbf' },
],
  ...
  },
  {
    ...
    detail: '对局内出现任何问题请保存录屏联系客服处理',
    notice: 'MF电竞点单须知<br>1.未成年人禁止下单，如有需要请在监护人陪同下进行；隐瞒年龄、执意购买者自行承担后果，与本店无关<br>2.对局内出现各种问题，如陪玩态度恶劣或恶意卡保底行为等请保存录屏及时联系客服处理<br>3.绝密单强制陪玩最低4听5甲，老板没带大红包的情况下陪玩必须给老板带<br>4.单价200r以下最低开一张房卡，单价200r-400r最低开三张房卡，单价400r以上包全卡，少开一张房卡保底+100w，通道卡陪玩必须全包<br>5.陪玩双倒的情况下老板兜底杀一个算炸一半，杀两个算炸单不计入保底，撤离失败保险物资价值不计入保底<br>6.机密炸单+30w保底，绝密炸单+该图战备同数（巴克什战备55w，航天战备60w，监狱战备78w）保底<br>7.单局带出不足100w不计入保底，老板不可故意丢弃或藏匿物资，一旦发现老板故意丢弃物资则直接结单，概不退款<br>8.对局中六套（6头耐久≥35，6甲耐久≥100）老板可选择性穿戴，计入保底总价值<br>9.陪玩局内出非洲之心以及海洋之泪必须免费给老板，老板自愿加鸡腿，心和泪计入保底<br>10.出现卡保底行为（结单时总带出价值≤保底＋炸单总价值+50w，赌约单除外），老板及时保存录屏联系客服处理<br>11.对局中请老板听从陪玩指挥，若老板因自身原因导致撤离失败则没有售后<br>12.老板可以提出合理要求，包括：想去哪里、想采用什么路线等，合理范围内的要求陪玩会尽量满足，没有提前说的要求不接受事后争议<br>13.禁止陪玩私加老板联系方式，老板无论以任何形式添加到陪玩联系方式，联系客服奖励200r<br>14.若因三角洲机制原因导致老板账号被追缴或封禁，该问题补偿方案如下:<br>（1）若确定是陪玩开挂则扣除打手押金并补偿给老板，该单全额退回并在封号期间按30/天补偿给老板，被追缴部分按60/ kw补偿给老板或者老板可选择联系客服安排其他陪玩车队打够追缴金额<br>（2）若是因为三角洲机制问题（如数据异常、打手绿玩但被举报次数过多、陪玩实力太强以及被官方判定为护航等）则正常结算订单以及以60/kw正常赔付追缴部分',
    platforms: makePlatforms(78, '单', '保底600w',128),
  },
  {
    id: 'b7',
    cat: 'baodi',
    ...
    detailImage: ['images/products/b7-cover.jpg',],
    desc: '保底800w',
    detail: '对局内出现任何问题请保存录屏联系客服处理',
    notice: 'MF电竞点单须知<br>1.未成年人禁止下单，如有需要请在监护人陪同下进行；隐瞒年龄、执意购买者自行承担后果，与本店无关<br>2.对局内出现各种问题，如陪玩态度恶劣或恶意卡保底行为等请保存录屏及时联系客服处理<br>3.绝密单强制陪玩最低4听5甲，老板没带大红包的情况下陪玩必须给老板带<br>4.单价200r以下最低开一张房卡，单价200r-400r最低开三张房卡，单价400r以上包全卡，少开一张房卡保底+100w，通道卡陪玩必须全包<br>5.陪玩双倒的情况下老板兜底杀一个算炸一半，杀两个算炸单不计入保底，撤离失败保险物资价值不计入保底<br>6.机密炸单+30w保底，绝密炸单+该图战备同数（巴克什战备55w，航天战备60w，监狱战备78w）保底<br>7.单局带出不足100w不计入保底，老板不可故意丢弃或藏匿物资，一旦发现老板故意丢弃物资则直接结单，概不退款<br>8.对局中六套（6头耐久≥35，6甲耐久≥100）老板可选择性穿戴，计入保底总价值<br>9.陪玩局内出非洲之心以及海洋之泪必须免费给老板，老板自愿加鸡腿，心和泪计入保底<br>10.出现卡保底行为（结单时总带出价值≤保底＋炸单总价值+50w，赌约单除外），老板及时保存录屏联系客服处理<br>11.对局中请老板听从陪玩指挥，若老板因自身原因导致撤离失败则没有售后<br>12.老板可以提出合理要求，包括：想去哪里、想采用什么路线等，合理范围内的要求陪玩会尽量满足，没有提前说的要求不接受事后争议<br>13.禁止陪玩私加老板联系方式，老板无论以任何形式添加到陪玩联系方式，联系客服奖励200r<br>14.若因三角洲机制原因导致老板账号被追缴或封禁，该问题补偿方案如下:<br>（1）若确定是陪玩开挂则扣除打手押金并补偿给老板，该单全额退回并在封号期间按30/天补偿给老板，被追缴部分按60/ kw补偿给老板或者老板可选择联系客服安排其他陪玩车队打够追缴金额<br>（2）若是因为三角洲机制问题（如数据异常、打手绿玩但被举报次数过多、陪玩实力太强以及被官方判定为护航等）则正常结算订单以及以60/kw正常赔付追缴部分',
    platforms: makePlatforms(98, '单', '保底800w',168),
  },
  ...
  },
  {
    ...
    detail: '对局内出现任何问题请保存录屏联系客服处理',
    notice: 'MF电竞点单须知<br>1.未成年人禁止下单，如有需要请在监护人陪同下进行；隐瞒年龄、执意购买者自行承担后果，与本店无关<br>2.对局内出现各种问题，如陪玩态度恶劣或恶意卡保底行为等请保存录屏及时联系客服处理<br>3.绝密单强制陪玩最低4听5甲，老板没带大红包的情况下陪玩必须给老板带<br>4.单价200r以下最低开一张房卡，单价200r-400r最低开三张房卡，单价400r以上包全卡，少开一张房卡保底+100w，通道卡陪玩必须全包<br>5.陪玩双倒的情况下老板兜底杀一个算炸一半，杀两个算炸单不计入保底，撤离失败保险物资价值不计入保底<br>6.机密炸单+30w保底，绝密炸单+该图战备同数（巴克什战备55w，航天战备60w，监狱战备78w）保底<br>7.单局带出不足100w不计入保底，老板不可故意丢弃或藏匿物资，一旦发现老板故意丢弃物资则直接结单，概不退款<br>8.对局中六套（6头耐久≥35，6甲耐久≥100）老板可选择性穿戴，计入保底总价值<br>9.陪玩局内出非洲之心以及海洋之泪必须免费给老板，老板自愿加鸡腿，心和泪计入保底<br>10.出现卡保底行为（结单时总带出价值≤保底＋炸单总价值+50w，赌约单除外），老板及时保存录屏联系客服处理<br>11.对局中请老板听从陪玩指挥，若老板因自身原因导致撤离失败则没有售后<br>12.老板可以提出合理要求，包括：想去哪里、想采用什么路线等，合理范围内的要求陪玩会尽量满足，没有提前说的要求不接受事后争议<br>13.禁止陪玩私加老板联系方式，老板无论以任何形式添加到陪玩联系方式，联系客服奖励200r<br>14.若因三角洲机制原因导致老板账号被追缴或封禁，该问题补偿方案如下:<br>（1）若确定是陪玩开挂则扣除打手押金并补偿给老板，该单全额退回并在封号期间按30/天补偿给老板，被追缴部分按60/ kw补偿给老板或者老板可选择联系客服安排其他陪玩车队打够追缴金额<br>（2）若是因为三角洲机制问题（如数据异常、打手绿玩但被举报次数过多、陪玩实力太强以及被官方判定为护航等）则正常结算订单以及以60/kw正常赔付追缴部分',
    platforms: makePlatforms(168, '单', '基础保底888w，不出不结单',188),
  },
  {
    id: 'd4',
    cat: 'duhong',
  ...
  },
  {
    ...
    detail: '对局内出现任何问题请保存录屏联系客服处理',
    notice: 'MF电竞点单须知<br>1.未成年人禁止下单，如有需要请在监护人陪同下进行；隐瞒年龄、执意购买者自行承担后果，与本店无关<br>2.对局内出现各种问题，如陪玩态度恶劣或恶意卡保底行为等请保存录屏及时联系客服处理<br>3.绝密单强制陪玩最低4听5甲，老板没带大红包的情况下陪玩必须给老板带<br>4.单价200r以下最低开一张房卡，单价200r-400r最低开三张房卡，单价400r以上包全卡，少开一张房卡保底+100w，通道卡陪玩必须全包<br>5.陪玩双倒的情况下老板兜底杀一个算炸一半，杀两个算炸单不计入保底，撤离失败保险物资价值不计入保底<br>6.机密炸单+30w保底，绝密炸单+该图战备同数（巴克什战备55w，航天战备60w，监狱战备78w）保底<br>7.单局带出不足100w不计入保底，老板不可故意丢弃或藏匿物资，一旦发现老板故意丢弃物资则直接结单，概不退款<br>8.对局中六套（6头耐久≥35，6甲耐久≥100）老板可选择性穿戴，计入保底总价值<br>9.陪玩局内出非洲之心以及海洋之泪必须免费给老板，老板自愿加鸡腿，心和泪计入保底<br>10.出现卡保底行为（结单时总带出价值≤保底＋炸单总价值+50w，赌约单除外），老板及时保存录屏联系客服处理<br>11.对局中请老板听从陪玩指挥，若老板因自身原因导致撤离失败则没有售后<br>12.老板可以提出合理要求，包括：想去哪里、想采用什么路线等，合理范围内的要求陪玩会尽量满足，没有提前说的要求不接受事后争议<br>13.禁止陪玩私加老板联系方式，老板无论以任何形式添加到陪玩联系方式，联系客服奖励200r<br>14.若因三角洲机制原因导致老板账号被追缴或封禁，该问题补偿方案如下:<br>（1）若确定是陪玩开挂则扣除打手押金并补偿给老板，该单全额退回并在封号期间按30/天补偿给老板，被追缴部分按60/ kw补偿给老板或者老板可选择联系客服安排其他陪玩车队打够追缴金额<br>（2）若是因为三角洲机制问题（如数据异常、打手绿玩但被举报次数过多、陪玩实力太强以及被官方判定为护航等）则正常结算订单以及以60/kw正常赔付追缴部分',
    platforms: makePlatforms(1188, '单', '无基础保底',2988),
  },
  {
    id: 'q3',
    cat: 'quwei',
